      ...
      <div className="text-center z-10 px-4 max-w-xl mx-auto">
        ...
        <RevealOnScroll>
          <div className="flex justify-center space-x-5 text-xs scale-65">
            ...
            <a
              href="#contact"
              className="bg-transparent text-white border-2 border-pink-400 py-3 px-6 rounded font-medium transition-all duration-300 hover:-translate-y-1 hover:border-pink-300 hover:bg-yellow-400/20 hover:shadow-lg rounded-4xl text-sm"
            >
              Contact Me
            </a>
