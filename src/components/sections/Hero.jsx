    ...
    <section className="min-h-[90vh] flex items-center justify-center py-20">
      ...
      >
        ...
        >
          <a
            href="#projects"
            className="px-8 py-3 rounded-full bg-gray-900 text-white font-medium hover:shadow-lg transition-all duration-300"
          >
            View Projects
          </a>
          <a
            href="#contact"
            className="px-8 py-3 rounded-full border-2 border-gray-900 text-gray-900 font-medium hover:bg-gray-900 hover:text-white transition-all duration-300"
          >
            Get in Touch
          </a>
        </motion.div>
