        ...
        >
          ...
          >
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-6 shadow-sm">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full px-6 py-3 rounded-lg bg-gray-900 dark:bg-white text-white dark:text-gray-900 font-medium hover:shadow-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                    disabled={isSubmitting}
                  >
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-6 shadow-sm">
              ...
              <div className="mt-8 p-4 bg-white dark:bg-gray-700 rounded-xl">
